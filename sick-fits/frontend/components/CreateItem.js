...
class CreateItem extends Component {
  ...
  uploadFile = async e => {
    ...
    const res = await fetch('https://api.cloudinary.com/v1_1/wesbostutorial/image/upload', { method: 'POST', body: data, });
        ...
        {(createItem, { loading, error }) => (
          <Form data-test="form" onSubmit={async e => {
            ...
            <fieldset disabled={loading} aria-busy={loading}>
              <label htmlFor="file">
                Image
                <input type="file" id="file" name="file" placeholder="Upload an image" required
